...
class TableCellProperties(XmlModel):
    ...
    # TODO If this element is omitted, then this cell shall not be part
    # of any vertically merged grouping of cells, and any vertically
    # merged group of preceding cells shall be closed.
