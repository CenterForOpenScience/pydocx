...
from pydocx.export.image_resize import ImageResizer, get_image_data_and_filename


class PyDocXHTMLExporterImageResizeMixin(object):
    def image(self, image_data, filename, x, y, uri_is_external):
        ...
        return super(
            PyDocXHTMLExporterImageResizeMixin,
            self,
        ).image(
